 ...
 // body of while loop executes each frame                                      // if FPS is 60, it will execute 60 times exery second
    ...
    while (!WindowShouldClose()){                                                                    
       ...
       //CHECK FOR COLLISSION BEFORE DRAWING SCARFY AND NEBULAE
            ...
            for (AnimData nebula : nebulae){                                    // for non-ranged for loop can also say for (int i = 0; i < sizeOfNebulae; i++){}                   
                float pad{50};                                                  // the nebula sprite has a bit of padding - meaning there will be a collision before scarfy even gets close to the nebula
                                                                                // so we can fix this by creating a smaller rectangle around the nebula more representative of the nebulas actual bounds
...
//OLD DELETED CODE for understanding AnimData
// AnimData for nebula
        AnimData nebData{ 
...
>>>>>>> f26b45c909bc3bb0f8ad6c5a4b56902b3bfc7ca5
}